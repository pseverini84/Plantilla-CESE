...
\begin{table}[h]
\centering
\caption[caption corto]{Corrientes de polarización}
...
\begin{itemize}
\item mode -a [minutos]: permite activar el modo de adquisición automático con un intervalo de tiempo [minutos]. Este modo inicializa la creación de un patrón de DP cada \textit{n} minutos.
