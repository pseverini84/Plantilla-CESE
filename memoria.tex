...
Una Descarga Parcial (DP) es un mecanismo de ruptura dieléctrica que tiene lugar en los sistemas aislantes de máquinas y equipos eléctricos de potencia. Su ocurrencia genera deterioros acumulativos en el sistema aislante que pone en riesgo sus propiedades dieléctricas, por este motivo es de interés su medición.
El presente trabajo trata sobre el desarrollo de un equipo para medir DP en máquinas y equipos eléctricos de potencia. El equipo desarrollado está basado en un microcontrolador LPC4370, puede funcionar de forma autónoma y es capaz de adquirir, almacenar y procesar pulsos de DP bajo una serie de parámetros configurables. La información obtenida es utilizada para representar de forma adecuada en lo que se conoce como Patrón de DP. Este constituye una herramienta estándar para el análisis de los sistemas aislantes de máquinas y equipos eléctricos de potencia.
